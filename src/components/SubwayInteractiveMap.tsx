...
const MAP_COORDINATES: Record<string, { x: number; y: number }> = {
  ...
  "SB12": { x: 740, y: 580 }, // 도곡
  "SB08": { x: 740, y: 520 }, // 선릉
  "SB18": { x: 700, y: 460 }, // 선정릉
  "SB19": { x: 640, y: 325 }, // 강남구청
  "SB20": { x: 630, y: 280 }, // 압구정로데오
  "SB21": { x: 620, y: 260 }, // 서울숲
  "SB22": { x: 620, y: 240 }, // 왕십리
  ...
  "801": { x: 880, y: 480 }, // 잠실
  "802": { x: 880, y: 530 }, // 석촌
  "807": { x: 860, y: 550 }, // 가락시장
  "803": { x: 920, y: 310 }, // 천호
  "806": { x: 920, y: 250 }, // 암사
  "804": { x: 860, y: 580 }, // 복정
  "808": { x: 860, y: 650 }, // 남한산성입구
  "805": { x: 860, y: 720 }, // 모란
